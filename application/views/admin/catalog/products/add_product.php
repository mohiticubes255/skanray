                                ...
                                <div class="m-portlet__body">
                                    <form method="post" id="add_product_form" enctype="multipart/form-data"> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="message-text" class="form-control-label">Product Speciality</label>
                                                    <select class="speciality form-control" name="speciality_id" id="speciality_id">
                                                        <option selected value="0">--SELECT SPECIALITY--</option>
                                                        <?php
                                                        foreach ($specialities["data"] as $speciality) {
                                                        ?>
                                                        <option value="<?= $speciality[1]; ?>"><?= $speciality[2]; ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="dicount_price" name="dicount_price" required>
                                                </div>
                                             </div>    
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="table-responsive">  
                                                ...
                                                <table class="table" id="dynamic_field">
                                                        ...
                                                        <tr id="row0" class="featuresrow">  

                                                            <td style="border:none!important;padding:0px 8px;"><input type="text" name="features[]" placeholder="Product Features" class="form-control name_list" required=""></td>  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="product_summary" class="form-control" id="product_summary" required></textarea>
                                        </div>
                                        <div class="form-group">
